...
export default class Cameracontents extends React.Component {
  ...
  render() {
    ...
    var thingToSay = 'Nutrition chart';
    Speech.speak(thingToSay);
      ...
      return (
        ...
        <View style={{ flex: 1, backgroundColor:'#011936'}}>
         ...
         <Image source={require('../assets/images/camerabtn.png')} style={{position:'absolute',zIndex:3,bottom:'5%',resizeMode:'contain',height:'25%',width:'25%',alignSelf:'center'}}></Image>
          <Text style={{color:'#fff', position:'absolute',zIndex:4,bottom:100, fontFamily:'Avenir', alignSelf:'center',fontSize:100}} onPress={() => takePicture()} >C</Text>
        </View>
      );
    }
  }
